...
-- ---@class ent
-- ---@field betterlb_atkspeedmodifier_val netvar
-- ---@field betterlb_atkspeedmodifier_modifier SourceModifierList
-- ---@field Modifier_betterlb_atkspeedmodifier fun(self,src:ent,m:number,key:string) # 直接在服务器调用这个实体的方法,来增加攻速,注意是 加算修饰
-- ---@field RemoveModifier_betterlb_atkspeedmodifier fun(self,src:ent,key:string) # 在服务器调用这个实体的方法,来移除攻速修饰

-- AddPlayerPostInit(function (inst)
--     inst.betterlb_atkspeedmodifier_val = net_float(inst.GUID, "betterlb_atkspeedmodifier")
--     if not TheWorld.ismastersim then
--         return inst
--     end
--     inst.betterlb_atkspeedmodifier_modifier = SourceModifierList(inst,0,SourceModifierList.additive)
--     function inst:Modifier_betterlb_atkspeedmodifier(src,m,key)
--         inst.betterlb_atkspeedmodifier_modifier:SetModifier(src,m,key)
--         local res = inst.betterlb_atkspeedmodifier_modifier:Get()
--         inst.betterlb_atkspeedmodifier_val:set(res)
--     end
--     function inst:RemoveModifier_betterlb_atkspeedmodifier(src,key)
--         inst.betterlb_atkspeedmodifier_modifier:RemoveModifier(src,key)
--         local res = inst.betterlb_atkspeedmodifier_modifier:Get()
--         inst.betterlb_atkspeedmodifier_val:set(res)
--     end
-- end)
...
--         if inst.betterlb_remove_sgtag_task then
--             inst.betterlb_remove_sgtag_task:Cancel()
...
--             local res = (inst.betterlb_atkspeedmodifier_modifier and inst.betterlb_atkspeedmodifier_modifier:Get()) or (inst.betterlb_atkspeedmodifier_val and inst.betterlb_atkspeedmodifier_val:value()) or 0
--             res = res + 1
...
--             inst.betterlb_remove_sgtag_task = inst:DoTaskInTime(newperiod,
--                 function()
