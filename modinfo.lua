...
local LANGS = {
    ['zh'] = {
        ...
        config = {
            ...
            { modid .. '_max_follow', '最大跟隨數量', '调整最多可以有幾隻光蟲跟隨玩家', false, {
                { '禁用', false, '若你希望使用其他模組的設定可以選' },
                { '1', 1 },
                { '2', 2 },
                { '3（原版）', 3 },
            ...
            { modid .. '_w_max_follow', '最大跟隨數量', '调整最多可以有幾隻光蟲跟隨玩家', false, {
                { '禁用', false, '若你希望使用其他模組的設定可以選' },
                { '1', 1 },
                { '2', 2 },
                { '3', 3 },
